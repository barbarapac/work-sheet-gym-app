  ...
  return (<>
    ...
    <SafeAreaView style={styles.container}> 
      <ScrollView style={styles.scrollView}>
        ...
        <View style={{paddingTop:20}}>
            <Text style={styles.texto} >Massa magra: <Text style={styles.data}>{dados.massaMagra}</Text></Text>
            <Text style={styles.texto} >Massa gorda: <Text style={styles.data}>{dados.massaGorda}</Text></Text>
        </View>
